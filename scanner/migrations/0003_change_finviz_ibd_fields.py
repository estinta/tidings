...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('scanner_stock', 'float', 'finviz_float')
        db.rename_column('scanner_stock', 'last_update', 'ibd_last_update')
        db.add_column('scanner_stock', 'finviz_last_update', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)), keep_default=False)
        db.add_column('scanner_stock', 'yahoo_last_update', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)), keep_default=False)
        db.add_column('scanner_stock', 'google_last_update', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)), keep_default=False)
        db.add_column('scanner_stock', 'msn_last_update', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)), keep_default=False)
        db.add_column('scanner_stock', 'briefing_last_update', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2000, 1, 1, 0, 0)), keep_default=False)

    def backwards(self, orm):
        db.rename_column('scanner_stock', 'finviz_float', 'float')
        db.rename_column('scanner_stock', 'ibd_last_update', 'last_update')
        db.delete_column('scanner_stock', 'finviz_last_update')
        db.delete_column('scanner_stock', 'yahoo_last_update')
        db.delete_column('scanner_stock', 'google_last_update')
        db.delete_column('scanner_stock', 'msn_last_update')
        db.delete_column('scanner_stock', 'briefing_last_update')
