...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.ibd_valid'
        db.add_column('scanner_userprofile', 'ibd_valid', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.briefing_valid'
        db.add_column('scanner_userprofile', 'briefing_valid', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.ibd_valid'
        db.delete_column('scanner_userprofile', 'ibd_valid')

        # Deleting field 'UserProfile.briefing_valid'
        db.delete_column('scanner_userprofile', 'briefing_valid')
