...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.briefing_user'
        db.add_column('scanner_userprofile', 'briefing_user', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'UserProfile.briefing_password'
        db.add_column('scanner_userprofile', 'briefing_password', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.briefing_user'
        db.delete_column('scanner_userprofile', 'briefing_user')

        # Deleting field 'UserProfile.briefing_password'
        db.delete_column('scanner_userprofile', 'briefing_password')
